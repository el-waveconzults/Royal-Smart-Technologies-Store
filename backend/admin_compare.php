...
$rows = $pdo->query("
    SELECT c.id, c.session_id, c.created_at, p.name, p.price, p.image 
    FROM compare c
    ...
    <nav class="sidebar">
        ...
        <ul class="nav-items">
         ...
         <a href="product_create.php"> <li>Create</li> </a>
          ...
          <a href="admin_compare.php"> <li class="active">Compare</li> </a>
      ...
      <main class="content">
        ...
        <div class="chart-container" style="overflow-x:auto;">
            <table style="width:100%;border-collapse:collapse;margin-top:20px;">
                ...
                <tbody>
                    <?php if (empty($rows)): ?>
                        <tr><td colspan="5" style="padding:20px;text-align:center;">No compare items found.</td></tr>
                    <?php else: ?>
